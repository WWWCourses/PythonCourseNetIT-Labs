...
12. Като се имат предвид следните три списъка, как бихте създали нов списък, който съответства на желания изход, отпечатан по-долу? (5 точки)
...
Б) Клас методът може да модифицира състоянието на класа, но не може директно да модифицира състоянието на инстанцията, която наследява от този клас.
...
20. Мениджмънта е пуснал запитване за създаване на база от данни за служители. Вие сте започнали с таблицата за служители. Кой е верният синтаксис? (5 точки)
